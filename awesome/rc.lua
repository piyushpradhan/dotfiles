...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, "Shift" }, "Return", function () awful.util.spawn( "rofi -show run" ) end,
        {description = "rofi launcher menu" , group = "rofi" }),
...
awful.rules.rules = {
    ...
    -- make polybar unfocusable, to remove the border      
    { rule = { class = "Polybar" },
...
client.connect_signal("focus", function(c) c.border_color = "#5F68A7" end)

awful.spawn.easy_async("/usr/bin/nm-applet")
awful.spawn.easy_async("/usr/bin/kmix")
awful.spawn.with_shell("nitrogen --restore")
awful.spawn.with_shell("~/.config/polybar/launch.sh --panels")
